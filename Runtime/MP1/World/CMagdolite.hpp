...
#else
  bool x754_24_retreat = false;
  bool x754_25_up = false;
  bool x754_26_lostMyHead = false;
  bool x754_27_flameThrowerActive = false;
  bool x754_28_alert = false;
  bool x754_29_useDetectionRange = true;
  bool x754_30_inProjectileAttack = false;
#endif
  float x758_ = 0.f;
